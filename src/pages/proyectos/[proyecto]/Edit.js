...
import EditFases from "../../../components/molecules/proyectos/EditFases.molecule";
...
import { useEditProyecto, useFetchDetalleProyecto } from "../../../services/Proyectos.service";
...
const EditProyecto = () => {
  ...
  const { loadingEdit, editProyecto } = useEditProyecto(values);
  ...
  return (
    <ListViewContainer>
      <HeaderContainer>
        <div>
          <PrimaryTitle>Editar Proyecto</PrimaryTitle>
        </div>
        <ButtonsContainer>
          <EVButton
            label="Cancelar"
